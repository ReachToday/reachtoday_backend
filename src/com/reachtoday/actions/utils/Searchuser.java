	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			JSONArray arr=new JSONArray();
				...
				resultSet = statement.executeQuery("select login_users_username,login_users_mail_id,login_users_isactive from login_users where login_users_username LIKE '%"+request.getParameter("username").trim().toLowerCase()+"%' and login_users_mail_id <> '"+request.getParameter("currentloggedmail").trim().toLowerCase()+"'");
